...
class EMOTICONS_CLASS_AddCategoryForm extends Form
{
    CONST FORM_NAME = 'smile-add-category';
    ...
    public function __construct()
    {
        ...
        $this->setAction(PEEP::getRouter()->urlForRoute('emoticons.admin_add_category'));
