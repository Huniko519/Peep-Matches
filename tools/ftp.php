...
class UTIL_Ftp
{
    ...
    public function init()
    {
        ...
        foreach ( $pathList as $path )
        {
            ...
            {
                $this->ftpRootDir = substr(PEEP_DIR_ROOT, 0, strpos(PEEP_DIR_ROOT, $path));
                break;
            }
        }
        ...
        if ( ftp_mkdir($this->stream, $dirname) )
        {
            ...
            $dirRootPathArr = array_filter(explode(DS, PEEP_DIR_ROOT));
