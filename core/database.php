...
final class PEEP_Database
{
    //const DEFAULT_CACHE_LIFETIME = false;
    const NO_CACHE_ENTRY = "peep_db_no_cache_entry";
    ...
    private function execute( $sql, array $params = null )
    {
        ...
        PEEP::getEventManager()->trigger(new PEEP_Event("core.sql.exec_query", array("sql" => $sql, "params" => $params)));
    ...
    {
        return !PEEP_DEV_MODE && $this->useCashe && ( $expTime === false || $expTime > 0 );
    }
    ...
    private function getFromCache( $sql, $params, $cacheLifeTime )
    {
        ...
        $data = PEEP::getEventManager()->call("core.sql.get_query_result", array("sql" => $sql, "params" => $params));
    ...
    private function saveToCache( $result, $sql, $params, $cacheLifeTime, $tags )
    {
        ...
        PEEP::getEventManager()->trigger(new PEEP_Event("core.sql.set_query_result", array("sql" => $sql, "params" => $params, "result" => $result)));
    }
}
