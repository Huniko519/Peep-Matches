...
var AdminMenu = function(menuIdList, closedItems)
{
    ...
    var copen = function(nodeClass){
        var $context = $('.peep_admin_menu_cont .'+nodeClass);
        var link = $('a.arrow', $context);
        $('.peep_admin_menu_cont .'+nodeClass+' a.arrow').trigger('click');
    };
    ...
    $.each( this.menuIdList,
        function(i, o){
            $el = $('.peep_admin_menu_cont .'+this+' a.arrow');
            $('.peep_admin_menu_cont .'+this+' a.label_link').bind('click', {data:this}, function(e){copen(e.data.data)});
...
$('#top_link').click(function(){window.adsForm = new PEEP_FloatBox({$title:'Add Banner', $contents: $('#top_form'), width: '550px', height: '350px', class: 'peep_ic_add'})});
*/