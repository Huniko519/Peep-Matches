PEEP_Components_DragAndDrop = function() {
    ...
    $('#reset_position_btn').click(function(){
    	if ( confirm( PEEP.getLanguageText('base', 'widgets_reset_position_confirm') ) ) {
...
PEEP_Components_DragAndDrop.prototype = new componentDragAndDrop ({
	...
	clone: function(sortable, $cloningItem) {
        ...
        var $destItem = $('<div class="peep_dnd_preloader peep_preloader_content peep_stdmargin"></div>');
	...
	handleStop: function(sortable, e, ui) {
    	...
    	var $preloader = $('<div class="peep_dnd_preloader peep_preloader_content peep_stdmargin"></div>');
