...
componentDragAndDrop.prototype = {
	...
	prepare: function()
		...
		this.defaultSettings = {
	        ...
	        beforeStop: function(e, ui) {
	        	if (ui.item.parent().hasClass('peep_dnd_locked_section'))
	        	{
    ...
    initializeSections: function() {
        ...
        var sectionSettings = this.extendSettings({
            ...
            receive: function(e, ui){
                if (ui.placeholder.hasClass('peep_dnd_placeholder')) {
    ...
    initializeActions: function() {
        ...
        this.$panel.find('.dd_delete').unbind().click(function() {
           if ( !confirm( PEEP.getLanguageText('base', 'widgets_delete_component_confirm') ) ) {
               return false;
           }
    ...
    initializeScheme: function() {
    	var $sliderNode = $('.peep_dnd_slider');
        ...
        $sliderNode.schemeSwitcher({
	    	...
	    	update: function(event){
	    		var schemeId = $(event.marker).attr('peep_scheme');
    ...
    getHelper: function(sortable, e, ui) {
        ...
        return $('<div class="peep_dnd_helper" style="width: 160px; height: 30px"></div>');
    },
    ...
    handlStart: function(sortable, e, ui) {
        ...
        var within = $(ui.item).attr('peep_avaliable_sections');
    ...
    handleStop: function(sortable, e, ui)
    {
        ...
        event.to = {
            section: toSection,
            sectionName: toSection.attr('peep_place_section')
        };
        event.from = {
            section: fromSection,
            sectionName: fromSection.attr('peep_place_section')
        };
        event.ui = ui;
    ...
    clone: function(sortable, $cloningItem) {
        ...
        var section = $(sortable).attr('peep_place_section');
    ...
    update: function(sortable) {
        ...
        var section = $selfNode.attr('peep_place_section');
        var stack = [];
    ...
    showSettings: function($component)
    {
        ...
        var $content = $('.settings_content', '#fb_settings').addClass('peep_preloader_content');
