...
class BASE_CMP_ContentPresenter extends PEEP_Component
{
...
class BASE_ContentPresenter extends PEEP_Component
{
    ...
    public function __construct( $content, $displayFormat ) 
    {
        ...
        $this->setTemplate(PEEP::getPluginManager()->getPlugin("base")
    ...
    public function onBeforeRender() 
    {
        ...
        $event = new PEEP_Event("content.before_presenter_render", array(
    ...
    protected function prepare() 
    {
        ...
        if ( $this->content['html'] )
        {
            ...
            $js->addScript('$("[data-action=play]", "#" + {$uniqId}).click(function(e) { '
                    ...
                    . '$(".peep_newsfeed_oembed_atch", "#" + {$uniqId}).addClass("peep_video_playing"); '
                    . '$(".peep_newsfeed_item_picture", "#" + {$uniqId}).html({$embed});'
                    . 'return false; });', array(
                "uniqId" => $this->uniqId,
                "embed" => $code
            ));
