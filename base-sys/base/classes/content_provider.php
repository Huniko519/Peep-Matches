...
class BASE_CLASS_ContentProvider
{
    ...
    public function onCommentAdd( PEEP_Event $event )
    {
        $params = $event->getParams();
    ...
    public function onUserJoin( PEEP_Event $event )
    {
        $params = $event->getParams();
    ...
    public function onUserDeleted( PEEP_Event $event )
    {
        $params = $event->getParams();
        $userId = $params["userId"];
    ...
    public function onUserApprove( PEEP_Event $event )
    {
        $params = $event->getParams();
        $userId = $params["userId"];
    ...
    public function onAvatarChange( PEEP_Event $event )
    {
        $params = $event->getParams();
    ...
    public function onAvatarDelete( PEEP_Event $event )
    {
        $params = $event->getParams();
        $avatarId = $params["avatarId"];
